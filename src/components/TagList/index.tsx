...
const TagLink = styled.div<{ selected?: boolean }>`
...
type Props =
  | {
      count: true;
      tagList: { fieldValue: string; totalCount: number }[];
      selected?: string;
    }
  | {
      count?: undefined;
      ...
      <TagListWrapper>
        {props.tagList.map((tag, i) => (
          <Link
            ...
            to={props.selected === tag.fieldValue ? '/tags' : `/tags?q=${tag.fieldValue}`}
          >
            <TagLink selected={tag.fieldValue === props.selected}>
