...
type MarkdownRemarkFields = {
  ...
  readonly ogImg: Maybe<Scalars['String']>;
  readonly slug: Maybe<Scalars['String']>;
  readonly tagSlugs: Maybe<ReadonlyArray<Maybe<Scalars['String']>>>;
};

type MarkdownRemarkFieldsFieldSelector = {
  readonly categorySlug: InputMaybe<FieldSelectorEnum>;
  readonly ogImg: InputMaybe<FieldSelectorEnum>;
  readonly slug: InputMaybe<FieldSelectorEnum>;
  readonly tagSlugs: InputMaybe<FieldSelectorEnum>;
};

type MarkdownRemarkFieldsFilterInput = {
  readonly categorySlug: InputMaybe<StringQueryOperatorInput>;
  readonly ogImg: InputMaybe<StringQueryOperatorInput>;
  readonly slug: InputMaybe<StringQueryOperatorInput>;
  readonly tagSlugs: InputMaybe<StringQueryOperatorInput>;
};

type MarkdownRemarkFieldsSortInput = {
  readonly categorySlug: InputMaybe<SortOrderEnum>;
  readonly ogImg: InputMaybe<SortOrderEnum>;
  readonly slug: InputMaybe<SortOrderEnum>;
  readonly tagSlugs: InputMaybe<SortOrderEnum>;
};
...
type BlogPostBySlugQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null, readonly markdownRemark: { readonly id: string, readonly excerpt: string | null, readonly html: string | null, readonly frontmatter: { readonly title: string, readonly description: string, readonly date: string, readonly update: string | null, readonly tags: ReadonlyArray<string>, readonly series: string | null, readonly img: string | null }, readonly fields: { readonly slug: string | null } | null } | null, readonly seriesList: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string } } }> }, readonly previous: { readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string } } | null, readonly next: { readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string } } | null };

type BlogSeriesBySeriesNameQueryVariables = Exact<{
  series: InputMaybe<Scalars['String']>;
}>;


type BlogSeriesBySeriesNameQuery = { readonly posts: { readonly nodes: ReadonlyArray<{ readonly excerpt: string | null, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly date: string, readonly update: string | null, readonly title: string, readonly tags: ReadonlyArray<string> } }> } };
